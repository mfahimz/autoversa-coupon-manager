...
export default function CouponsPage() {
  ...
  async function loadData() {
    ...
    let query = supabase
      .from('coupons')
      .select('id, coupon_code, identifier_type, plate_combined_string, mobile_number, car_model, offer_title, advisor_name, issue_date, expiry_date, status, redemption_count')
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F7F7F7', paddingTop: '16px' }}>
      ...
      <main style={{ padding: '0 32px 48px' }}>
        ...
        <div style={{
          ...
          <div style={{
            display: 'grid',
            gridTemplateColumns: '2fr 1.5fr 1.5fr 1fr 1fr 1fr 120px',
                ...
                <div key={coupon.id} style={{
                  ...
                  <div>
                    ...
                    <p style={{
                      ...
                      color: isExpired && coupon.status === 'ACTIVE' ? '#D0021B' : '#888',
                    }}>
