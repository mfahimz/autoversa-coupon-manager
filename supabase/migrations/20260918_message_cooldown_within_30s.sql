-- Update record_broadcast_contact_sent RPC to restrict randomized delay between individual messages within 30 seconds (15–30s)
...
BEGIN
  ...
  ELSE
    ...
    -- Randomized cooldown restricted within 30 seconds (15 to 30 seconds) within an active wave
    v_new_cooldown := v_sent_at + (15 + floor(random() * 16))::integer * interval '1 second';
  END IF;
